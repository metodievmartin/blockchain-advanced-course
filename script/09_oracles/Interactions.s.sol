...
contract CreateSubscription is Script {
    ...
    function createSubscription(
        ...
        // 2. Log the subscription ID
        console.log("Your subscription Id is: ", subId);
        console.log("Please update the subscriptionId in HelperConfig.s.sol");

        // 3. Return the subscription ID and the VRF coordinator address
...
contract AddConsumer is Script {
    function addConsumer(
        ...
        // Add the consumer contract to the VRF coordinator
        vm.startBroadcast(account);
...
contract FundSubscription is CodeConstants, Script {
    ...
    function fundSubscriptionUsingConfig() public {
        ...
        // 1. Get the subscription ID, VRF coordinator address, and link address
        uint256 subId = helperConfig.getConfig().subscriptionId;
        address vrfCoordinatorV2_5 = helperConfig
            .getConfig()
            .vrfCoordinatorV2_5;
        ...
        // 2. If the subscription ID is 0, create a new subscription
        if (subId == 0) {
